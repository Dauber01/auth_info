...
const file_api_proto_common_proto_rawDesc = "" +
	"\n" +
	"\x16api/proto/common.proto\x12\x03api\">\n" +
	"\x0eOperationReply\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageB#Z!auth_info/api/gen/api/proto;apipbb\x06proto3"
...
var file_api_proto_common_proto_goTypes = []any{
	(*OperationReply)(nil), // 0: api.OperationReply
}
